    ...
    try {
      ...
      try {
        ...
        if (localProduct) {
          ...
          // Auto-select first available variant from local data
          if (localProduct.variants && localProduct.variants.length > 0) {
            const firstVariant = localProduct.variants[0];
            setSelectedVariant(firstVariant);
            if (firstVariant.color) setSelectedColor(firstVariant.color);
            if (firstVariant.size) setSelectedSize(firstVariant.size);
          }
            ...
            <form className="mt-6">
              ...
              <div className="mt-10 flex sm:flex-col1">
                <button
                  ...
                  className="max-w-xs flex-1 bg-gray-100 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-gray-900 hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 sm:w-full disabled:bg-gray-700 disabled:cursor-not-allowed disabled:text-gray-500 transition-colors"
                >
